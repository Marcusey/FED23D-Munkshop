(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const d of o.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&a(d)}).observe(document,{childList:!0,subtree:!0});function r(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(n){if(n.ep)return;n.ep=!0;const o=r(n);fetch(n.href,o)}})();document.addEventListener("DOMContentLoaded",()=>{c(),b(),C(),l();const t=document.querySelector("form");t&&(t.addEventListener("submit",h),t.querySelectorAll("input[required], select[required], textarea[required]").forEach(r=>{r.addEventListener("input",m)}),m())});const u=document.querySelector("#sprayCansForSale"),s=document.querySelector("#cartSection");function v(t){const e=document.createElement("div");e.className="popup",e.textContent=t,document.body.appendChild(e),setTimeout(()=>{e.remove()},3e3)}function h(t){t.preventDefault(),v("Thanks for you order!!"),y()}function m(){const t=document.querySelector("form"),e=document.querySelector("#sendForm"),r=t.checkValidity();e.disabled=!r}const i=[{id:1,name:"CanCan in Sunset",price:100,image:{src:"orange.jpg",alt:"Spray Can 1 Image"},amount:0,stars:4,category:"light"},{id:2,name:"Yellow Mr. Sunshine",price:120,image:{src:"assets/pictures/yellow.jpg",alt:"Spray Can 2 Image"},amount:0,stars:3.5,category:"light"},{id:3,name:"Red Rush ",price:140,image:{src:"assets/pictures/red.jpg",alt:"Spray Can 3 Image"},amount:0,stars:5,category:"light"},{id:4,name:"Pink that Party",price:110,image:{src:"assets/pictures/pink.jpg",alt:"Spray Can 4 Image"},amount:0,stars:4.5,category:"pastel"},{id:5,name:"Bloom Fusia, bloom",price:110,image:{src:"assets/pictures/fusia.jpg",alt:"Spray Can 5 Image"},amount:0,stars:3,category:"light"},{id:6,name:"Cast a spell",price:100,image:{src:"assets/pictures/chrome.jpg",alt:"Spray Can 6 Image"},amount:0,stars:4,category:"light"},{id:7,name:"Blue Lagoon",price:140,image:{src:"assets/pictures/blue.jpg",alt:"Spray Can 7 Image"},amount:0,stars:4.5,category:"light"},{id:8,name:"Blue Velvet",price:130,image:{src:"assets/pictures/darkblue.jpg",alt:"Spray Can 8 Image"},amount:0,stars:3.5,category:"dark"},{id:9,name:"Greener than grass",price:140,image:{src:"assets/pictures/green.jpg",alt:"Spray Can 9 Image"},amount:0,stars:4,category:"dark"}];function S(){const t=localStorage.getItem("cart");return t?JSON.parse(t):[]}function f(t){localStorage.setItem("cart",JSON.stringify(t))}function C(){window.addEventListener("beforeunload",()=>{f(i)})}function b(){const t=S();t.length>0&&i.forEach(e=>{const r=t.find(a=>a.id===e.id);r&&(e.amount=r.amount)})}function L(){i.sort((t,e)=>e.stars-t.stars),c()}function E(t){const e=i.filter(r=>r.category===t);u.innerHTML="",e.forEach(r=>{u.innerHTML+=`
    ...
    `}let p;function l(){clearTimeout(p),p=setTimeout(()=>{alert("Sorry, you have been gone for too long!"),i.forEach(t=>t.amount=0),f(i),c()},15*60*1e3)}function q(t){const e=Number(t.currentTarget.dataset.id),r=i.findIndex(a=>a.id===e);i[r].amount>0&&(i[r].amount-=1),c(),l()}function k(t){const e=Number(t.currentTarget.dataset.id),r=i.findIndex(a=>a.id===e);i[r].amount+=1,c(),l()}function c(){u.innerHTML="",$(),i.forEach(r=>{u.innerHTML+=`
      <article>
        <h1>${r.name}</h1>
        <img src="${r.image.src}" alt="${r.image.alt}">
        <div>Price: <span>${r.discountedPrice.toFixed(2)}</span> kr</div>
